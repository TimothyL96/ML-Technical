...
CREATE TABLE user (id INT UNSIGNED NOT NULL AUTO_INCREMENT, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, date_created TIMESTAMP NOT NULL, CONSTRAINT PK_USER PRIMARY KEY (id), UNIQUE (email));
